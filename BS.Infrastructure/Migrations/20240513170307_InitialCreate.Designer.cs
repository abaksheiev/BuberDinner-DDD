...
namespace BS.Infrastructure.Migrations
{
    ...
    [Migration("20240513170307_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BS.Domain.MenuAggregates.Menu", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BS.Domain.MenuAggregates.Menu", b =>
                {
                    b.OwnsOne("BS.Domain.Common.ValueObjects.AverageRating", "AverageRating", b1 =>
                        {
                    ...
                    b.OwnsMany("BS.Domain.Dinner.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("BS.Domain.MenuAggregates.Entities.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("BS.Domain.MenuAggregates.ValueObjects.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("BS.Domain.MenuReview.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
